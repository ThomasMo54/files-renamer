...
import com.motompro.filesrenamer.modifier.*
...
class RemoveTextController : ModifierDialogController {
    ...
    private fun onValidateButtonClick(event: ActionEvent) {
        val textToRemove = textInput.text
